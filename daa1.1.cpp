// Analyse if stack is empty , is full and if elements are present then return top element in stack using templates and also perform push and pop operation in the stack
